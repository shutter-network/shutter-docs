...
_Many thanks to Julian Ma, Drew Van der Werff, Alex Vinyas, Martin Köppelmann, Marc Harvey-Hill, Phillippe Schommers, and Julie Bettens for their valuable feedback on this document._
...
2.  **Step 2 - (Optional) Integration with Relays**:
...
3.  **Encryption Protocol Integrity**:
...
5.  **Submitting Modified Block to Proposer**:\
...
3.  **Block Acceptance by Proposer**:
...
5.  **Block Construction and Proposer Validation**:
...
2.  **Decryption and Network Coordination**:
...
3.  **Key Release Upon Block Publication**:\
...
4.  **Attester Validation of Decryption Keys**:\
...
2.  **Attester Majority Validation**:
